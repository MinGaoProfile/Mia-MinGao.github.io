function generateCV(personName) {
    ...
    doc.text(27, 7, doc.splitTextToSize('gaom@ohsu.edu', 10));

    doc.setTextColor(0, 0, 0);
    doc.text(24, 9, 'Website:');
    doc.setTextColor(0, 0, 255);
    doc.text(28, 9, 'https://Mia-MinGao.github.io');

    doc.setTextColor(0, 0, 0);
    doc.text(24, 11, 'Google Scholar:');
    doc.setTextColor(0, 0, 255);
    doc.text(31, 11, 'https://bit.ly/GoogleScholar-MinGao');
    ...
    doc.setFont('times', 'normal');
    doc.text(4, 17.3, '2019            M.S.  Computer Science and Technology, Shandong Normal University, Jinan, China');
    doc.text(4, 18.6, '2016            B.S.  Computer Science and Technology, Shandong Normal University, Jinan, China');
    ...
    doc.text(4, 23, '2022 - present      Research Associate, Oregon Health & Science University, Portland OR, U.S.');
    doc.text(4, 24.3, '2019 - 2022        Research Assistant, Oregon Health & Science University, Portland OR, U.S.');
    ...
    doc.output('save', 'CV - Min Gao.pdf');
